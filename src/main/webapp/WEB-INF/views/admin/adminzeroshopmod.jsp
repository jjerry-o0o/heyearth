...
<div class='admincontext'>
	<table class='adminmodinserttable'>
		<tr><td>이름</td><td><input id="s_name" name="s_name" class="admintd" type="text" placeholder="가게 이름을 입력해주세요" value="${zeroshopinfo.s_name}" required></td></tr>
		<tr><td>웹사이트</td><td><input id="s_url" name="s_url" class="admintd" type="url" placeholder="(예시) http://www.naver.com (전체 url을 넣어주세요)" value="${zeroshopinfo.s_url}" required></td></tr>
		<tr><td>분류</td><td><input id="s_inform" name="s_inform" class="admintd" type="text" placeholder="(예시) 잡화 / 카페 / 리필스테이션 /" value="${zeroshopinfo.s_inform}" required></td></tr>
		...
		<tr><td>전화번호</td><td><input id="s_call" name="s_call" class="admintd" type="text" placeholder="000-0000-0000 (하이픈을 넣어주세요)" pattern="[0-9]{2,4}-[0-9]{3,4}-[0-9]{4}" maxlength="14" value="${zeroshopinfo.s_call}"></td></tr>
		<tr><td>휴무일</td><td><input id="s_close" name="s_close" class="admintd" type="text" placeholder="(예시) 월" value="${zeroshopinfo.s_close}"></td></tr>
		<tr><td>영업시간</td><td><input id="s_hour" name="s_hour" class="admintd" type="text" placeholder="(예시) 10:00-20:00" value="${zeroshopinfo.s_hour}"></td></tr>
		<tr><td>사진</td>
		<td>
