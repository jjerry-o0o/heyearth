...
<script src="/js/admin/adminmemberboardmod.js"></script>
...
<form action='adminmemberboardmodinfo' method='post' enctype="multipart/form-data">
...
<div class='admincontext'>
	<table class='adminmodinserttable'>
		...
		<tr><td>작성자</td><td>${boardinfo.id }<input id="id" type="hidden" name="id" value="${boardinfo.id }"></td></tr>
